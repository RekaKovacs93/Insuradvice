export default function Garancia () {
    return (
        <div className=" ">
            ...
            <div className=" my-10 lg: flex flex-col justify-center">
            
            
                <h1 className="lg:text-5xl text-3xl mb-10 text-center ">Tájékozódj és dönts tudatosan!</h1>
                <p className="text-center lg:mx-20 mx-10 mb-20">Az anyagi döntések meghozatala fontos és felelősségteljes feladat. Azonban ne aggódj, nem vagy egyedül. Én itt vagyok, hogy segítsek neked minden lépésben, hogy biztonságban érezd magad és elérd pénzügyi céljaidat.</p>
