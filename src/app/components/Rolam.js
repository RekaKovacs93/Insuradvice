...
export default function Rolam() {
  ...
  <div>
    <div className="md:flex w-screen block my-40">
      <div className="md:w-2/5 md:mx-20 justify-center">
        <h1 className="text-6xl md:mb-0 mb-20 hidden md:block">Vadász Róbert</h1>
      </div>
      <div className="md:mx-40 mx-10 md:w-3/5 flex flex-col justify-center items-center shadow-neumorphic-inverse md:p-20 p-5 rounded-lg">
        <p className="text-3xl text-center mb-10">Üdvözöllek az Insuradvice honlapján!</p>
        <p className="md:text-xl text-center">Ha itt vagy, akkor valószínűleg te is feltetted már magadnak az alábbi kérdéseket: 
