export default function Nyugdij () {
    return (
        <div id="nyugdij">
            ...
            <p className="text-center px-20">A nyugdíj kérdése sokakat foglalkoztat, és az adatok alapján egyértelműen látszik, hogy ez egy
            ...
            <p className="mb-20 text-center px-20">A nyugdíjbiztosítás egy olyan hosszú távú pénzügyi eszköz, amely garantált jövedelmet nyújt
