...
export default function Nyugdij () {
    return (
        <div id="nyugdij" className="shadow-neumorphic-inverse rounded-lg flex flex-col items-center">
            {/* <h1 className="text-center text-3xl lg:text-5xl lg:px-10 lg:py-5 py-3 lg:my-20 my-10">Pénzügyi termékek fontossága</h1> */}
            <h1 className="text-center text-3xl lg:text-5xl lg:px-10 lg:py-20 py-3 ">Nyugdíjbiztosítás</h1>
            <p className="text-center lg:px-20 mb-10">A nyugdíj kérdése sokakat foglalkoztat, és az adatok alapján egyértelműen látszik, hogy ez egy
            ...
            {/* <p className="mb-20 text-center lg:px-20">A nyugdíjbiztosítás egy olyan hosszú távú pénzügyi eszköz, amely garantált jövedelmet nyújt
                ...
                <div className= "shadow-neumorphic-slim my-10 px-10 py-5 rounded-lg">
                    <h1 className="text-center text-xl lg:text-3xl lg:px-10 lg:py-0 py-3 lg:my-0  text-accentLight dark:text-accent my-10">Nyugdíjbiztosítás előnyei</h1>

                    <ul className="mt-5 text-xl text-center">
                        <li className="mb-2"><p className="inline text-accentLight dark:text-accent text-2xl">&#10003;</p> Garantált hozam</li>
                        <li className="mb-2"><p className="inline text-accentLight dark:text-accent text-2xl">&#10003;</p> Tervezhető jövedelem</li>
                        <li className="mb-2"><p className="inline text-accentLight dark:text-accent text-2xl">&#10003;</p> Akár évi 130.000 Ft adókedvezmény</li>
                        <li className="mb-2"><p className="inline text-accentLight dark:text-accent text-2xl">&#10003;</p> Bónuszok és jóváírások</li>
                    </ul>
                </div>
            <p className="lg:my-10 mb-10 text-center lg:px-20">Az alábbi táblázatban található a nyugdíjbiztosítások lejárati összege, szerződéskezdeti életkor, illetve havi megtakarítási összeg szerint. (A táblázatban található összegek csak iránymutatóként szolgálnak, részletes és pontos tájékoztatásért személyes konzultáció szükséges, nyugdíjbiztosítás 30 éves kor alatt is indítható)</p>  
        <Tablazat></Tablazat>
        </div>
    )
}