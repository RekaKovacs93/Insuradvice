export default function Nyugdij () {
    return (
        <div id="nyugdij">
            ...
            <h1 className="text-center text-xl lg:text-3xl lg:px-10 lg:py-5 py-3 my-10">Nyugdíjbiztosítás</h1>
            <p className="text-center">A nyugdíj kérdése sokakat foglalkoztat, és az adatok alapján egyértelműen látszik, hogy ez egy
                komoly probléma, amelyre megoldást kell találnunk. <b>A KSH 2023-as adatai szerint 1485 milliárd
                ...
                szakember, segítek neked.</p>
            <h1 className="text-center text-xl lg:text-xl lg:px-10 lg:py-5 py-3 my-10">Nyugdíjbiztosítás előnyei</h1>
            <p className="mb-20 text-center">A nyugdíjbiztosítás egy olyan hosszú távú pénzügyi eszköz, amely garantált jövedelmet nyújt
                ...
                nyugdíjbiztosítási befizetések után,<b> az éves befizetéseid 20%-át, de legfeljebb 130.000 Ft-ot </b>
