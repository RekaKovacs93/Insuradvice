export default function Nyugdij () {
    return (
        <div id="nyugdij">
            ...
            <p className="text-center lg:px-20 ">A nyugdíj kérdése sokakat foglalkoztat, és az adatok alapján egyértelműen látszik, hogy ez egy
