export default function Nyugdij () {
    return (
        <div id="nyugdij">
            ...
            <p>A nyugdíj kérdése sokakat foglalkoztat, és az adatok alapján egyértelműen látszik, hogy ez egy
            ...
            <h1 className="text-center text-xl lg:text-3xl lg:px-10 lg:py-5 py-3 my-10">Nyugdíjbiztosítás előnyei</h1>
            <p className="mb-20">A nyugdíjbiztosítás egy olyan hosszú távú pénzügyi eszköz, amely garantált jövedelmet nyújt
