...
export default function Eletbiztositas() {
  ...
  useEffect(() => {
    const handleMouseEnter = (event) => {
      ...
      .from(hexagon, {
        ...
        filter: "drop-shadow(0px 0px 10px var(--accemnt50))",
      })
    ...
    const handleMouseLeave = (event) => {
      ...
      gsap.to(hexagon, {
        filter: "drop-shadow(5px 5px 10px var(--hexshadow))",
        duration: 1,
      });
    };
  ...
  return (
    <div className="flex flex-col items-center w-full justify-center min-h-screen">
      <h1 className="text-center  text-5xl px-10 md:py-5 py-3 my-20">Ismerd meg Öngondkoskodási formáinkat</h1>
      ...
      <div className="hidden sm:flex flex-col sm:flex-row flex-wrap justify-center gap-x-4 items-center mx-40 relative top-[-50px]">
