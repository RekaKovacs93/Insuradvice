  ...
  return (
    <nav className={`fixed top-0 w-full  z-10 transition-opacity duration-500 fade-in ${visible ? 'opacity-100' : 'opacity-0 -translate-y-full'}`}>
      ...
      {/* <div > */}
        ...
        <div className="hidden md:flex flex-grow items-center justify-end space-x-8 text-lg">
          ...
          <label
            ...
            className="cursor-pointer relative w-10 h-6 flex items-center justify-between bg-gray-400 rounded-full p-1"
          >
            <div className="w-5 h-5 bg-white rounded-full shadow-md transform translate-x-0 transition-transform duration-300" />
          </label>
